...
# region path config
tracklist_path = pathlib.Path("data/track_list.csv") # within the virtual env, the data folder can be accessed without the .., I'll this here for you so you can swap it back if need be "../../data/track_list.csv"
features_path = pathlib.Path("data/track_features.csv") # "../../data/track_features.csv"
